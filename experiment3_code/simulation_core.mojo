...
#         # mutation from min to max without looking at the previous value

#         var mutation_value: Int
#         if gene_to_mutate == TRANSITION_AGE_GENE:
#             mutation_value = rng.next_range(min_mutation_amount, 60+1)
#         else: 
#             mutation_value = rng.next_range(min_mutation_amount, max_mutation_amount+1)
